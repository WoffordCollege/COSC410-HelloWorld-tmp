...
The directory structure that is assumed by Gradle (though it can be changed if you want) is as follows:
    ...
    project root     (root directory of project, probably "cosc420-hello-world")
               |
...
`build/libs/<name>.jar`
: This file (where *name* is specified in the jar settings of `gradle.build`, "cosc420-hello-world-1.0.jar" in this case) is the fully bundled code for the project. You can run this by saying
